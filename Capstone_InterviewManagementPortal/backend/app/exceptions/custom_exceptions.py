...
class AppException(HTTPException):
    ...
    def __init__(self, status_code: int, detail: str, headers: Mapping[str, str] | None = None):
...
class UnauthorizedException(AppException):
    ...
    def __init__(self, detail: str = "Unauthorized", headers: Mapping[str, str] | None = None):
